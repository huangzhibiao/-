...
- (void)setFrame:(CGRect)frame
{
    ...
    //_lastUpdateTimeLabel.frame = CGRectMake(statusX, lastUpdateY,0,0);//statusWidth, statusHeight BG - 后改 修改时间 : 2016/1/7 14:11
    
    // 3.箭头
    //CGFloat arrowX = w * 0.5 - 100;BG - 后改 修改时间 : 2016/1/7 14:11
    _arrowImage.center = CGPointMake((statusX+(statusWidth-15)*0.5),statusY-20);//(arrowX,h * 0.5); BG - 后改 修改时间 : 2016/1/7 14:11
